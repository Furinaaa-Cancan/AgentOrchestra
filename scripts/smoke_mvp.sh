...
"$PY_BIN" scripts/mvp_ctl.py validate-skill --skill-dir skills/task-decompose
"$PY_BIN" scripts/mvp_ctl.py validate-skill --skill-dir skills/code-implement
"$PY_BIN" scripts/mvp_ctl.py validate-skill --skill-dir skills/test-and-review

echo "[2/6] Validate task"
"$PY_BIN" scripts/mvp_ctl.py validate-task --task tasks/examples/task-code-implement.json

echo "[3/6] Route task"
"$PY_BIN" scripts/mvp_ctl.py route --task tasks/examples/task-code-implement.json --agents agents/profiles.json

echo "[4/6] Verify checks (pass case)"
"$PY_BIN" scripts/mvp_ctl.py verify-checks --task tasks/examples/task-code-implement.json --results tasks/examples/check-results-pass.json

echo "[5/6] Validate lock lifecycle"
"$PY_BIN" scripts/lockctl.py acquire --task-id task-api-user-create --file-path scripts/mvp_ctl.py --ttl-sec 30
"$PY_BIN" scripts/lockctl.py list
"$PY_BIN" scripts/lockctl.py renew --task-id task-api-user-create --file-path scripts/mvp_ctl.py --ttl-sec 30
"$PY_BIN" scripts/lockctl.py release --task-id task-api-user-create --file-path scripts/mvp_ctl.py
